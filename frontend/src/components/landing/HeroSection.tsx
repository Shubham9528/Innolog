  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-28 overflow-hidden bg-grid-pattern">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl lg:max-w-6xl mx-auto">
          
          {/* Pill Badge */}
          <div className="inline-flex items-center space-x-2 bg-indigo-50/90 border border-indigo-100 text-indigo-700 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-8 shadow-sm max-w-full">
            <Sparkles className="w-3.5 h-3.5 text-indigo-600 shrink-0" />
            <span>Autoclave Data Logging System • IoT Sterilization Monitoring</span>
          </div>

          {/* Main Headline */}
          <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 mb-8 leading-[1.18]">
            <span className="block mb-2">Sterilization Data Logging.</span>
            <span className="gradient-text inline-block pb-1">Real-Time Precision &amp; Compliance.</span>
          </h1>
